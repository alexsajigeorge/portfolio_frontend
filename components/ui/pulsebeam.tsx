...
export const PulseBeams = () => {
  return (
    <div className="flex h-[40rem] w-full relative items-center justify-center antialiased bg-black overflow-hidden">
...
const GradientColors = () => {
  return (
    <>
      <stop stopColor="var(--emerald-500)" stopOpacity="0"></stop>
      <stop stopColor="var(--emerald-500)"></stop>
      <stop offset="0.325" stopColor="var(--emerald-300)"></stop>
      <stop offset="1" stopColor="var(--emerald-100)" stopOpacity="0"></stop>
    </>
  );
};
