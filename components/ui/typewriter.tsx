  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={cn(
          "inline-block rounded-sm w-[1px] h-4 md:h-6 lg:h-10 bg-emerald-500",
          cursorClassName
        )}
      ></motion.span>
    </div>
...
const TypewriterEffectSmooth = ({
  ...
  return (
    <div className={cn("flex space-x-1 my-6", className)}>
      ...
      >
        <div
          className="text-2xl sm:text-3xl lg:text-5xl font-bold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400 pointer-events-none"
          style={{
            whiteSpace: "nowrap",
          }}
        >
      ...
      <motion.span
        ...
        className={cn(
          "block rounded-sm w-[1px] h-8 sm:h-8 lg:h-12 bg-emerald-500",
          cursorClassName
        )}
      ></motion.span>
    </div>
